...
@property (nonatomic, weak) UIImage *levelImage;
@end
...
- (void)addAtrribuedLabel
{
    ...
    NSArray *verticalContrainsts = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-2-[label]-2-|" options:0 metrics:nil views:@{@"label":_label}];
