...
#pragma mark - gggg文本空心字及颜色

- (void)addAttributeStrokeWidth1:(unichar)strokeWidth
                    strokeColor:(UIColor *)strokeColor
{
    [self addAttributeStrokeWidth1:strokeWidth strokeColor:strokeColor range:NSMakeRange(0, self.length)];
}
