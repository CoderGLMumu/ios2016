...
//     NSLog(@"leftScale--%lf--%@--%zd , rightScale-- %lf--%@--%zd",leftScale,leftButton.titleLabel.text,leftButton.selected,rightScale,rightButton.titleLabel.text,rightButton.selected);
     ...
     */
    CGFloat redR = (33 *(1- rightScale)) / 255.0 ;
    CGFloat greenR = (33 * (1- rightScale)) / 255.0;
    CGFloat blueR = (33  * (1- rightScale)) / 255.0 ;
    UIColor *rightColor = [UIColor colorWithRed:redR green:greenR blue:blueR alpha:1];
//    UIColor *rightColor = [UIColor hx_colorWithHexRGBAString:@"2195f3"];
    [rightButton setTitleColor:rightColor forState:UIControlStateNormal];
    
    CGFloat redL = (33 *(leftScale)) / 255.0 ;
    CGFloat greenL = (149 *(leftScale)) / 255.0;
    CGFloat blueL = (243 * (leftScale)) / 255.0;
    UIColor *leftColor = [UIColor colorWithRed:redL green:greenL blue:blueL alpha:1];
//    UIColor *leftColor = [UIColor hx_colorWithHexRGBAString:@"212121"];
