...
#define HSCachesDirectory [[LocalDataRW getDirectory:Directory_BB] stringByAppendingPathComponent:@"RecoderCache"]
...
//// 评论音频文件的存放路径（caches）Recoder文件的存放路径（caches）
//#define RecoderFileFullpath(url) [RecoderCachesDirectory stringByAppendingPathComponent:HSFileName(url)]
