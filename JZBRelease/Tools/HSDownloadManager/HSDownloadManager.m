...
/**
 *  RecoderFileFullpath创建缓存目录文件
 */
//- (void)createCacheDirectoryWithRecoderCachesDirectory
//{
//    NSFileManager *fileManager = [NSFileManager defaultManager];
//    if (![fileManager fileExistsAtPath:RecoderCachesDirectory]) {
//        [fileManager createDirectoryAtPath:RecoderCachesDirectory withIntermediateDirectories:NO attributes:nil error:NULL];
//    }
//}
...
//    [self createCacheDirectoryWithRecoderCachesDirectory];
