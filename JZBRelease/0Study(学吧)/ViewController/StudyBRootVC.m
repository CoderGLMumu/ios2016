...
@interface StudyBRootVC () <UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    statusBarView.backgroundColor = [UIColor hx_colorWithHexRGBAString:@"2198f2"];
    statusBarView.frame = CGRectMake(0, 0, self.view.glw_width, 20);
...
//    01直播
        UIViewController *glmotivesealVc = [[UIViewController alloc]init];
    
        glmotivesealVc.title = @"疯狂在线";
...
//        点播
        UIViewController *glDynamicVc = [[UIViewController alloc]init];
    
        glDynamicVc.title = @"成长空间";
...
- (void)setupTitleScrollView
{
    ...
    CGFloat btnX = 0;
    CGFloat btnY = 0;
    CGFloat btnW = titleBtnView.glw_width / 2;  // 暂时就3个.由于平分,暂时没有滚动效果.
