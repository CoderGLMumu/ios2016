...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
//        self.contentView.backgroundColor = [ValuesFromXML getColor:[ValuesFromXML getValueWithName:@"efeff4" WithKind:XMLTypeColors]];
        [self.asyncDisplayView setBackgroundColor:[ValuesFromXML getColor:[ValuesFromXML getValueWithName:@"fffcee" WithKind:XMLTypeColors]]];
        [self.contentView addSubview:self.asyncDisplayView];
        self.asyncDisplayView.center = self.contentView.center;
    }
    return self;
}
