...
-(void)Action
{
    ...
    [self donghuaView:self.PhotoView Rect:CGRectMake(10,(SCREEN_HEIGHT_-200)/2,self.frame.size.width-20, 100)];
    [self donghuaView:self.keyBordView Rect:CGRectMake(0,SCREEN_HEIGHT_-200,self.frame.size.width, 200)];
...
-(void)allocPasswrod
{
    ...
    self.backView=[[UIView alloc] initWithFrame:CGRectMake(0, 0,SCREEN_WIDTH_,SCREEN_HEIGHT_)];
    ...
    self.PhotoView=[[UIView alloc] initWithFrame:CGRectMake(10,SCREEN_HEIGHT_, SCREEN_WIDTH_-20, 100)];
...
#pragma 方法写得笨，勿喷
    ...
    la1= [[UITextField alloc] initWithFrame:CGRectMake((SCREEN_WIDTH_-240)/2, 30, 40, 40)];
    ...
    la2= [[UITextField alloc] initWithFrame:CGRectMake((SCREEN_WIDTH_-240)/2+40, 30, 40, 40)];
    ...
    la3= [[UITextField alloc] initWithFrame:CGRectMake((SCREEN_WIDTH_-240)/2+80, 30, 40, 40)];
    ...
    la4= [[UITextField alloc] initWithFrame:CGRectMake((SCREEN_WIDTH_-240)/2+120, 30, 40, 40)];
    ...
    la5= [[UITextField alloc] initWithFrame:CGRectMake((SCREEN_WIDTH_-240)/2+160, 30, 40, 40)];
    ...
    la6= [[UITextField alloc] initWithFrame:CGRectMake((SCREEN_WIDTH_-240)/2+200, 30, 40, 40)];
    ...
    self.keyBordView=[[UIView alloc] initWithFrame:CGRectMake(0,SCREEN_HEIGHT_,SCREEN_WIDTH_,200)];
    ...
    for(int i=0;i<ary.count;i++)
    {
        ...
        btn.frame = CGRectMake(index * (SCREEN_WIDTH_/3), page  * 50,SCREEN_WIDTH_/3,50);
        btn.tag=i;
...
-(void)hiddenBackVew
{
    ...
    self.vc.tabBarController.tabBar.hidden = NO;
}
