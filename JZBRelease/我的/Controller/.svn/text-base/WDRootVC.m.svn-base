...
//        self.lastButton = self.wdkcButton;
    ...
    [self.panNameLabel setTextColor:[UIColor hx_colorWithHexRGBAString:@"212121"]];
...
//    [self.userAvaImageView sd_setImageWithURL:[NSURL URLWithString:[AddHostToLoadPIC AddHostToLoadPICWithString:self.users.avatar]] placeholderImage:[UIImage imageNamed:@"ZCCG_TX"]];
    ...
    [LocalDataRW getImageWithDirectory:Directory_WD RetalivePath:[[ValuesFromXML getValueWithName:@"Images_Absolute_Address" WithKind:XMLTypeNetPort] stringByAppendingPathComponent:self.users.avatar] WithContainerImageView:self.userAvaImageView];
