...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if ([[UIApplication sharedApplication].keyWindow.rootViewController isKindOfClass:[HomeTabBarVC class]]) {
        HomeTabBarVC *homeTabBarVC = (HomeTabBarVC *)[UIApplication sharedApplication].keyWindow.rootViewController;
        UINavigationController *navVC = homeTabBarVC.childViewControllers[3];
        
//        NSInteger i = navVC.tabBarItem.badgeValue.integerValue;
        
//        i += [updateTabBarBadge updateTabBarBadgeNum].integerValue;
//        navVC.tabBarItem.badgeValue = [NSString stringWithFormat:@"%ld",(long)i];
        
        GLLog(@"更新navVC.tabBarItem.badgeValue1%@",[updateTabBarBadge updateTabBarBadgeNum]);
        
        
        
        NSUserDefaults *udefault = [NSUserDefaults standardUserDefaults];
        NSInteger preEnterChatTabBarBadgeValue = [udefault integerForKey:@"preEnterChatTabBarBadgeValueKey"];
        
        //        NSInteger i = navVC.tabBarItem.badgeValue.integerValue;
        
        //        i += [updateTabBarBadge updateTabBarBadgeNum].integerValue;
        navVC.tabBarItem.badgeValue = [NSString stringWithFormat:@"%ld",preEnterChatTabBarBadgeValue += [updateTabBarBadge updateTabBarBadgeNum].integerValue];
        
        if ([navVC.tabBarItem.badgeValue isEqualToString:@"0"]) {
            navVC.tabBarItem.badgeValue = nil;
        }
        
        //        GLLog(@"更新navVC.tabBarItem.badgeValue1%@",navVC.tabBarItem.badgeValue);
