...
//        _searchBar.backgroundColor = [UIColor colorWithRed:0.747 green:0.756 blue:0.751 alpha:1.000];
        _searchBar.backgroundColor = [UIColor hx_colorWithHexRGBAString:@"ffffff"];
    }
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    [contentView setBackgroundColor:[UIColor hx_colorWithHexRGBAString:@"eeeeee"]];
    return contentView;
}
...
- (void)createGroup
{
//NSLog(@"createGroupcreateGroupcreateGroupcreateGroupcreateGroupcreateGroup");
